...
export default function Footer() {
  return (
    <section className="container margin-50">
      <div className="row">
        <div className="col-4">
            <div className="flex flex-column flex-start gap-5 padding-tb-5 border-right-gray height-full">
        ...
        <div className="col-4">
            <div className="flex flex-column flex-start gap-5 padding-tb-5 height-full">
